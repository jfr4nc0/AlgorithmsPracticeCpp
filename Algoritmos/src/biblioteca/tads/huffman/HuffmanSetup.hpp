...
#ifndef SRC_BIBLIOTECA_TADS_HUFFMAN_HUFFMANSETUP_HPP_
#define SRC_BIBLIOTECA_TADS_HUFFMAN_HUFFMANSETUP_HPP_
...
#endif /* SRC_BIBLIOTECA_TADS_HUFFMAN_HUFFMANSETUP_HPP_ */
